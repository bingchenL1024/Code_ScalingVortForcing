...
plot(t_nond_fit,exp(-t_nond_fit),'LineWidth',linewidth_thick+0.5,'LineStyle','--','Color','r')
hold on 
errorbar(ct_binmean.dx_bincenter,ct_binmean.cxt_binmean,ct_binmean.error_binmean,'-s','LineWidth',linewidth_thick-0.3,'MarkerSize',3,'MarkerFaceColor','m','color','m','LineStyle','-.')
xlim([0,8])
ylim([0,1])
ylabel('')
...
xtickangle(0)
niceplot_nobold_nomintick(fig_fontsize)
text(6.8,0.93,subfiglabel{2},'FontSize',subfiglabel_fontsz,'Interpreter','latex')
