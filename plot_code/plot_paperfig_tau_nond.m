...
errorbar(tau_nond_stats.x_mean,tau_nond_stats.binmean,tau_nond_stats.binstd,'.','LineWidth',1.5,'Color','c')
%xlim([0,1])
%ylim([0,8])
yticks(0:2:8)
hold off
xlabel('$x/L_{\mathrm{sz}}$','Interpreter','latex')
...
plot(tau_nond_fit.G0_nond_fit,tau_nond_fit.tau_nond_fit,'LineWidth',3,'Color','c','LineStyle','--')
xlim([0,1])
%ylim([0,8])
