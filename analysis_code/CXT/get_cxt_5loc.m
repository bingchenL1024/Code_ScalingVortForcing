...
for i = 1:24
    for j = 1:5
        ...
        fitpara_5loc.slp2(i).dirspr_b(j) = fitpara.slp2(i).dirspr_b(ind_5loc_temp(j));
    ...
    for j = 1:5
        ...
        fitpara_5loc.slp3(i).dirspr_b(j) = fitpara.slp3(i).dirspr_b(ind_5loc_temp(j));
    ...
    for j = 1:5
        ...
        fitpara_5loc.slp4(i).dirspr_b(j) = fitpara.slp4(i).dirspr_b(ind_5loc_temp(j));
...
[x_nond_tot_5loc] = get_combine_3slp_24run(fitpara_5loc,'x_nond',1);
...
[tau_decoscale_nond_tot_5loc] = t_decoscal_tot_5loc./(get_combine_3slp_24run(fitpara_5loc,'t_scale2',1));
[t_scale_tot_5loc] = get_combine_3slp_24run(fitpara_5loc,'t_scale',1);
[t_scale2_tot_5loc] = get_combine_3slp_24run(fitpara_5loc,'t_scale2',1);

%======================get binmean =============================
ct_binmean = cxt_binmean_CT(cxt_data_5loc_tot,t_nond_diva_tot_5loc,10,[0.8,8]); %25 is number of bin and [0.8, 1] is the xlim 


[t_nond_stats.binmean,t_nond_stats.binstd] = bin_mean_taunondVSxnond(x_nond_tot_5loc,t_decoscal_tot_5loc,t_scale2_tot_5loc);
...
tau_nond_fit.fskill= falk_skill(f_nond_tau_scale(G0_nond_tot_5loc(ind_nonan)),tau_decoscale_nond_tot_5loc(ind_nonan));
tau_nond_fit.rmse= rmse(f_nond_tau_scale(G0_nond_tot_5loc(ind_nonan)),tau_decoscale_nond_tot_5loc(ind_nonan));


head = 'data generated in get_cxt_5loc.m';
save('/data1/bliu/data/cxt_alongct_max_dxwidth_fitpara_qced_5loc','fitpara_5loc','t_decoscal_tot_5loc','tau_nond_fit','Dw_nond_tot_5loc','cFbr_para_nond_tot_5loc','tau_decoscale_nond_tot_5loc','G0_nond_tot_5loc','t_scale2_tot_5loc','t_nond_stats','t_scale_tot_5loc','x_nond_tot_5loc','t_nond_diva_tot_5loc','cxt_data_5loc_tot','ct_binmean','head')
